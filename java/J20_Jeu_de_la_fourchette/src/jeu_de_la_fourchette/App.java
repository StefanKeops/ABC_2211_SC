...
/*VARIABLE
 ...
 Générer aléatoirement un nombre entier compris entre 1 et 1000 et le stocker dans une variable nombre_Random
...
public class App {
	...
	public static void main(String[] args) {
	    ...
	    int nombre_Random = rand.nextInt(1000) + 1;
	    int nombre_saisi;
	    ArrayList<Integer> tentatives = new ArrayList<>();
	    int nb_essais = 0;
	    do {
	      System.out.println("Devinez le nombre Random (entre 1 et 1000) :");
