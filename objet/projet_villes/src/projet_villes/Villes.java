...
public class Villes {
	...
	public Villes(String pNomVille, int nbre, String pNomPays)
	{
	...
	{
		int[] bornesSuperieur = {0, 1000, 10000, 100000, 500000, 1000000, 2000000, 3000000, 4000000, 5000000, 10000000, 15000000};
